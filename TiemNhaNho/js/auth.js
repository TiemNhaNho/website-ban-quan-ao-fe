...
async function handleLogin(event) {
    ...
    const email = document.querySelector('#nav-sign-in input[name="username"]').value;
    const password = document.querySelector('#nav-sign-in input[name="password"]').value;
    ...
    try {
        ...
        if (data.code === '200' && data.data) {
            ...
            showMessage('Tài khoản của bạn đã bị vô hiệu hóa. Vui lòng liên hệ hỗ trợ.', 'error');
...
async function handleRegister(event) {
    ...
    const username = document.querySelector('#nav-register input[name="username"]').value;
    const email = document.querySelector('#nav-register input[name="username"]').value;
    const password = document.querySelector('#nav-register input[name="password"]').value;
